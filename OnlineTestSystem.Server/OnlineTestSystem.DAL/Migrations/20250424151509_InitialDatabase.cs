        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessCode = table.Column<string>(type: "varchar(20)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Exam_StartBeforeEnd", "[StartTime] < [EndTime]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizCategories_QuizCategories_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Quiz_Duration", "[Duration] >= 1 AND [Duration] <= 3600");
                    table.ForeignKey(
                        name: "FK_Quizzes_QuizCategories_Category",
                        column: x => x.Category,
                        principalTable: "QuizCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UserManager = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Groups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Groups_AspNetUsers_UserManager",
                        column: x => x.UserManager,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_QuestionBanks_QuizCategories_QuizCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefreshToken_ExpireAfterAdded", "[DateExpire] > [DateAdded]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamQuizzes", x => new { x.ExamId, x.QuizId });
                    table.ForeignKey(
                        name: "FK_ExamQuizzes_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamQuizzes_Quizzes_QuizId",
                        column: x => x.QuizId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserQuiz_Score", "[Score] >= 0");
                    table.CheckConstraint("CK_UserQuiz_StartBeforeEnd", "[StartedAt] < [FinishedAt]");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserQuizzes_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamGroups", x => new { x.ExamId, x.GroupId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Question_Level", "[Level] IN ('Easy', 'Medium', 'Hard')");
                    table.CheckConstraint("CK_Question_Type", "[QuestionType] IN ('MultipleChoice', 'SingleChoice', 'TrueFalse','FillInTheBlanks','ShortAnswer','LongAnswer','Listening','Speaking')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_QuizQuestion_Score", "[Score] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserVoiceUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamQuizzes_QuizId",
                table: "ExamQuizzes",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_UserManager",
                table: "Groups",
                column: "UserManager");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionBanks_QuizCategoryId",
                table: "QuestionBanks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizCategories_ParentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserQuizzes_UserId_QuizId_ExamId",
                table: "UserQuizzes",
                columns: new[] { "UserId", "QuizId", "ExamId" },
                unique: true,
